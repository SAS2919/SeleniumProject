...
public class AllGenericMethods extends BaseC
{
	...
	public static String TakeScreencapture() throws IOException
	{
		...
		File destinationPath = new File("C:\\Users\\DELL\\Documents\\Selenium ws\\Screenshots"
	...
	public static boolean Checkbox_IsSelected(String checkboxname, By element)
	{
		boolean flag = false;
		List<WebElement>allcheckbox = driver.findElements(element);
		
		for (int i=0; i<=allcheckbox.size()-1; i++) 
		{
			if(checkboxname.equals(allcheckbox.get(i).getDomProperty("value")))
			{
